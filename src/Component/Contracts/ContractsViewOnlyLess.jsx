...
import { Tooltip,Button,Form,Input,Select,Radio,Popover,Checkbox,Tag,Table,DatePicker,Divider } from 'antd';
...
class ContractsViewOnlyLess extends Contracts {
    //@override
    actionRender(text, row, index){
        return <p className={"_mark"}>
                    <a href="javascript:void(0)">定价单</a>
...
export default ContractsViewOnlyLess;